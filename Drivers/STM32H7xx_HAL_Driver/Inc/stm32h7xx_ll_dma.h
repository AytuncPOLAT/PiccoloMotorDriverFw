 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_EnableStream(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;

	SET_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_EN);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_DisableStream(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 */
__STATIC_INLINE uint32_t LL_DMA_IsEnabledStream(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	return ((READ_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
							+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR,
			DMA_SxCR_EN) == (DMA_SxCR_EN)) ? 1UL : 0UL);
}
...
__STATIC_INLINE void LL_DMA_ConfigTransfer(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t Configuration)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR,
			DMA_SxCR_DIR | DMA_SxCR_CIRC | DMA_SxCR_PINC | DMA_SxCR_MINC | DMA_SxCR_PSIZE | DMA_SxCR_MSIZE | DMA_SxCR_PL | DMA_SxCR_PFCTRL | DMA_SxCR_DBM | DMA_SxCR_CT,
			Configuration);
}
		...
		uint32_t Stream, uint32_t Direction)
{
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_DIR,
			Direction);
}
...
__STATIC_INLINE uint32_t LL_DMA_GetDataTransferDirection(
		const DMA_TypeDef *DMAx, uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetMode(const DMA_TypeDef *DMAx, uint32_t Stream,
		uint32_t Mode)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
...
__STATIC_INLINE void LL_DMA_SetPeriphIncMode(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t IncrementMode)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;

	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_PINC,
			IncrementMode);
}
		...
		uint32_t Stream, uint32_t IncrementMode)
{
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_MINC,
			IncrementMode);
}
...
__STATIC_INLINE void LL_DMA_SetPeriphSize(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t Size)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;

	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_PSIZE,
			Size);
}
		...
		uint32_t Stream, uint32_t Size)
{
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_MSIZE,
			Size);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetIncOffsetSize(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t OffsetSize)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;

	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_PINCOS,
			OffsetSize);
}
 ...
 *         @arg @ref LL_DMA_OFFSETSIZE_FIXEDTO4
 */
__STATIC_INLINE uint32_t LL_DMA_GetIncOffsetSize(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetStreamPriorityLevel(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t Priority)
{
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_PL,
			Priority);
}
 ...
 *         @arg @ref LL_DMA_PRIORITY_VERYHIGH
 */
__STATIC_INLINE uint32_t LL_DMA_GetStreamPriorityLevel(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_EnableBufferableTransfer(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	SET_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_TRBUFF);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_DisableBufferableTransfer(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
...
__STATIC_INLINE void LL_DMA_SetDataLength(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t NbData)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;

	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->NDTR, DMA_SxNDT, NbData);
}
		...
		uint32_t Stream)
{
	...
	return (READ_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->NDTR, DMA_SxNDT));
}
/**
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetPeriphRequest(DMA_TypeDef *DMAx, uint32_t Stream,
		uint32_t Request)
{
	MODIFY_REG(
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetMemoryBurstxfer(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t Mburst)
{
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_MBURST,
			Mburst);
}
 ...
 *         @arg @ref LL_DMA_MBURST_INC16
 */
__STATIC_INLINE uint32_t LL_DMA_GetMemoryBurstxfer(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetPeriphBurstxfer(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t Pburst)
{
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_PBURST,
			Pburst);
}
 ...
 *         @arg @ref LL_DMA_PBURST_INC16
 */
__STATIC_INLINE uint32_t LL_DMA_GetPeriphBurstxfer(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetCurrentTargetMem(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t CurrentMemory)
{
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_CT,
			CurrentMemory);
}
 ...
 *         @arg @ref LL_DMA_CURRENTTARGETMEM1
 */
__STATIC_INLINE uint32_t LL_DMA_GetCurrentTargetMem(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_EnableDoubleBufferMode(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	SET_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_DBM);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_DisableDoubleBufferMode(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DMA_IsEnabledDoubleBufferMode(
		const DMA_TypeDef *DMAx, uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	return ((READ_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
							+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR,
			DMA_SxCR_DBM) == (DMA_SxCR_DBM)) ? 1UL : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t LL_DMA_GetFIFOStatus(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	return (READ_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->FCR, DMA_SxFCR_FS));
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_DisableFifoMode(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	CLEAR_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->FCR, DMA_SxFCR_DMDIS);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_EnableFifoMode(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetFIFOThreshold(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t Threshold)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;

	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->FCR, DMA_SxFCR_FTH,
			Threshold);
}
 ...
 *         @arg @ref LL_DMA_FIFOTHRESHOLD_FULL
 */
__STATIC_INLINE uint32_t LL_DMA_GetFIFOThreshold(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_ConfigFifo(const DMA_TypeDef *DMAx, uint32_t Stream,
		uint32_t FifoMode, uint32_t FifoThreshold)
{
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->FCR,
...
__STATIC_INLINE void LL_DMA_ConfigAddresses(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t SrcAddress, uint32_t DstAddress,
		uint32_t Direction)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	if (Direction == LL_DMA_DIRECTION_MEMORY_TO_PERIPH)
	{
		WRITE_REG(
				((DMA_Stream_TypeDef* )(dma_base_addr
						+ LL_DMA_STR_OFFSET_TAB[Stream]))->M0AR, SrcAddress);
		WRITE_REG(
				((DMA_Stream_TypeDef* )(dma_base_addr
						+ LL_DMA_STR_OFFSET_TAB[Stream]))->PAR, DstAddress);
	}
	...
	else
	{
		WRITE_REG(
				((DMA_Stream_TypeDef* )(dma_base_addr
						+ LL_DMA_STR_OFFSET_TAB[Stream]))->PAR, SrcAddress);
		WRITE_REG(
				((DMA_Stream_TypeDef* )(dma_base_addr
						+ LL_DMA_STR_OFFSET_TAB[Stream]))->M0AR, DstAddress);
	}
}
...
__STATIC_INLINE void LL_DMA_SetMemoryAddress(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t MemoryAddress)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;

	WRITE_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->M0AR, MemoryAddress);
}
...
__STATIC_INLINE void LL_DMA_SetPeriphAddress(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t PeriphAddress)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;

	WRITE_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->PAR, PeriphAddress);
}
		...
		uint32_t Stream)
{
	...
	return (READ_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->M0AR));
}
		...
		uint32_t Stream)
{
	...
	return (READ_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->PAR));
}
		...
		uint32_t Stream, uint32_t MemoryAddress)
{
	...
	WRITE_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->PAR, MemoryAddress);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetMemory1Address(const DMA_TypeDef *DMAx,
		uint32_t Stream, uint32_t Address)
{
	...
	MODIFY_REG(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->M1AR, DMA_SxM1AR_M1A,
			Address);
}
 ...
 * @retval Between 0 to 0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_DMA_GetMemory1Address(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;

	return (((DMA_Stream_TypeDef*) (dma_base_addr
			+ LL_DMA_STR_OFFSET_TAB[Stream]))->M1AR);
}
		...
		uint32_t Stream)
{
	...
	SET_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_HTIE);
}
		...
		uint32_t Stream)
{
	...
	SET_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_TEIE);
}
		...
		uint32_t Stream)
{
	...
	SET_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_TCIE);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_EnableIT_DME(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	SET_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_DMEIE);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_EnableIT_FE(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	SET_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
					+ LL_DMA_STR_OFFSET_TAB[Stream]))->FCR, DMA_SxFCR_FEIE);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_DisableIT_DME(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_DisableIT_FE(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
		...
		uint32_t Stream)
{
	...
	return ((READ_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
							+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR,
			DMA_SxCR_HTIE) == DMA_SxCR_HTIE) ? 1UL : 0UL);
}
		...
		uint32_t Stream)
{
	...
	return ((READ_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
							+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR,
			DMA_SxCR_TEIE) == DMA_SxCR_TEIE) ? 1UL : 0UL);
}
		...
		uint32_t Stream)
{
	...
	return ((READ_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
							+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR,
			DMA_SxCR_TCIE) == DMA_SxCR_TCIE) ? 1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_DME(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	return ((READ_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
							+ LL_DMA_STR_OFFSET_TAB[Stream]))->CR,
			DMA_SxCR_DMEIE) == DMA_SxCR_DMEIE) ? 1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_FE(const DMA_TypeDef *DMAx,
		uint32_t Stream)
{
	uint32_t dma_base_addr = (uint32_t) DMAx;
	...
	return ((READ_BIT(
			((DMA_Stream_TypeDef* )(dma_base_addr
							+ LL_DMA_STR_OFFSET_TAB[Stream]))->FCR,
			DMA_SxFCR_FEIE) == DMA_SxFCR_FEIE) ? 1UL : 0UL);
}
