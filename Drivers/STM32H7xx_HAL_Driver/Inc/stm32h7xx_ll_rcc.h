...
{
#if defined(RCC_D1CCIPR_FMCSEL)
	uint32_t *pReg = (uint32_t*) ((uint32_t) &RCC->D1CCIPR
...
#endif /* RCC_D1CCIPR_FMCSEL */
	return (uint32_t) (Periph
			| (((READ_BIT(*pReg, LL_CLKSOURCE_MASK(Periph)))
...
{
	return ((READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLL1FRACEN)
			== RCC_PLLCFGR_PLL1FRACEN) ? 1UL : 0UL);
}
...
{
	MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_N1,
			(N - 1UL) << RCC_PLL1DIVR_N1_Pos);
}
...
{
	MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_P1,
			(P - 1UL) << RCC_PLL1DIVR_P1_Pos);
}
...
{
	MODIFY_REG(RCC->PLL1DIVR, RCC_PLL1DIVR_R1,
			(R - 1UL) << RCC_PLL1DIVR_R1_Pos);
}
...
{
	return ((READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLL2FRACEN)
			== RCC_PLLCFGR_PLL2FRACEN) ? 1UL : 0UL);
}
...
{
	MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_N2,
			(N - 1UL) << RCC_PLL2DIVR_N2_Pos);
}
...
{
	MODIFY_REG(RCC->PLLCKSELR, RCC_PLLCKSELR_DIVM2,
...
{
	MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_P2,
			(P - 1UL) << RCC_PLL2DIVR_P2_Pos);
}
...
{
	MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_Q2,
			(Q - 1UL) << RCC_PLL2DIVR_Q2_Pos);
}
...
{
	MODIFY_REG(RCC->PLL2DIVR, RCC_PLL2DIVR_R2,
			(R - 1UL) << RCC_PLL2DIVR_R2_Pos);
}
...
{
	return ((READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLL3FRACEN)
			== RCC_PLLCFGR_PLL3FRACEN) ? 1UL : 0UL);
}
...
{
	MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_N3,
			(N - 1UL) << RCC_PLL3DIVR_N3_Pos);
}
...
{
	MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_P3,
			(P - 1UL) << RCC_PLL3DIVR_P3_Pos);
}
...
{
	MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_Q3,
			(Q - 1UL) << RCC_PLL3DIVR_Q3_Pos);
}
...
{
	MODIFY_REG(RCC->PLL3DIVR, RCC_PLL3DIVR_R3,
			(R - 1UL) << RCC_PLL3DIVR_R3_Pos);
}
...
{
	return ((READ_BIT(RCC->CIFR, RCC_CIFR_CSIRDYF) == (RCC_CIFR_CSIRDYF)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(RCC->CIFR, RCC_CIFR_HSECSSF) == (RCC_CIFR_HSECSSF)) ?
			1UL : 0UL);
}
...
#else
	return ((READ_BIT(RCC->RSR, RCC_RSR_LPWRRSTF) == (RCC_RSR_LPWRRSTF)) ?
			1UL : 0UL);
#endif /*DUAL_CORE*/
}
...
{
	return ((READ_BIT(RCC->RSR, RCC_RSR_WWDG1RSTF) == (RCC_RSR_WWDG1RSTF)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(RCC->RSR, RCC_RSR_IWDG1RSTF) == (RCC_RSR_IWDG1RSTF)) ?
			1UL : 0UL);
}
...
#else
	return ((READ_BIT(RCC->RSR, RCC_RSR_SFTRSTF) == (RCC_RSR_SFTRSTF)) ?
			1UL : 0UL);
#endif  /*DUAL_CORE*/
}
...
{
	return ((READ_BIT(RCC->RSR, RCC_RSR_PORRSTF) == (RCC_RSR_PORRSTF)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(RCC->RSR, RCC_RSR_PINRSTF) == (RCC_RSR_PINRSTF)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(RCC->RSR, RCC_RSR_BORRSTF) == (RCC_RSR_BORRSTF)) ?
			1UL : 0UL);
}
...
#else
	return ((READ_BIT(RCC->RSR, RCC_RSR_CPURSTF) == (RCC_RSR_CPURSTF)) ?
			1UL : 0UL);
#endif/*DUAL_CORE*/
}
...
{
	return ((READ_BIT(RCC->CIER, RCC_CIER_CSIRDYIE) == RCC_CIER_CSIRDYIE) ?
			1UL : 0UL);
}
