...
{
	return ((READ_BIT(SPIx->CFG2, SPI_CFG2_IOSWP) == (SPI_CFG2_IOSWP)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->CFG2, SPI_CFG2_AFCNTR) == (SPI_CFG2_AFCNTR)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->CR1, SPI_CR1_IOLOCK) == (SPI_CR1_IOLOCK)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->CR1, SPI_CR1_CRC33_17) == (SPI_CR1_CRC33_17)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->CR1, SPI_CR1_CSTART) == (SPI_CR1_CSTART)) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_SPI_IsEnabledMasterRxAutoSuspend(
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_TXTFIE) == (SPI_IER_TXTFIE)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_CRCEIE) == (SPI_IER_CRCEIE)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_TIFREIE) == (SPI_IER_TIFREIE)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_MODFIE) == (SPI_IER_MODFIE)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_TSERFIE) == (SPI_IER_TSERFIE)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->CFG1, SPI_CFG1_RXDMAEN) == (SPI_CFG1_RXDMAEN)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SPIx->CFG1, SPI_CFG1_TXDMAEN) == (SPI_CFG1_TXDMAEN)) ?
			1UL : 0UL);
}
/**
		...
		uint32_t DataLength)
{
	MODIFY_REG(SPIx->I2SCFGR,
			SPI_I2SCFGR_DATLEN | SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_DATFMT,
			DataLength);
}
 ...
 * @retval State of bit (1 or 0)
 */
__STATIC_INLINE uint32_t LL_I2S_IsEnabledWordSelectInversion(
		const SPI_TypeDef *SPIx)
{
	return ((READ_BIT(SPIx->I2SCFGR, SPI_I2SCFGR_WSINV) == (SPI_I2SCFGR_WSINV)) ?
			1UL : 0UL);
}
...
{
	MODIFY_REG(SPIx->I2SCFGR, SPI_I2SCFGR_I2SDIV,
			(PrescalerLinear << SPI_I2SCFGR_I2SDIV_Pos));
}
...
{
	return (uint32_t) (READ_BIT(SPIx->I2SCFGR, SPI_I2SCFGR_I2SDIV)
...
{
	MODIFY_REG(SPIx->I2SCFGR, SPI_I2SCFGR_ODD,
...
{
	return (uint32_t) (READ_BIT(SPIx->I2SCFGR, SPI_I2SCFGR_ODD)
			>> SPI_I2SCFGR_ODD_Pos);
}
...
{
	return ((READ_BIT(SPIx->I2SCFGR, SPI_I2SCFGR_MCKOE) == (SPI_I2SCFGR_MCKOE)) ?
			1UL : 0UL);
}
