...
{ (uint16_t) 1, (uint16_t) 2, (uint16_t) 4, (uint16_t) 6, (uint16_t) 8,
		(uint16_t) 10, (uint16_t) 12, (uint16_t) 16, (uint16_t) 32,
 ...
 *         @arg @ref LL_LPUART_FIFOTHRESHOLD_8_8
 */
__STATIC_INLINE uint32_t LL_LPUART_GetTXFIFOThreshold(
 ...
 *         @arg @ref LL_LPUART_FIFOTHRESHOLD_8_8
 */
__STATIC_INLINE uint32_t LL_LPUART_GetRXFIFOThreshold(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledInStopMode(
		const USART_TypeDef *LPUARTx)
{
...
{
	MODIFY_REG(LPUARTx->PRESC, USART_PRESC_PRESCALER,
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledOverrunDetect(
		const USART_TypeDef *LPUARTx)
{
...
__STATIC_INLINE void LL_LPUART_SetBaudRate(USART_TypeDef *LPUARTx,
		uint32_t PeriphClk, uint32_t PrescalerValue, uint32_t BaudRate)
{
	if (BaudRate != 0U)
	{
...
__STATIC_INLINE uint32_t LL_LPUART_GetBaudRate(const USART_TypeDef *LPUARTx,
		uint32_t PeriphClk, uint32_t PrescalerValue)
{
	uint32_t lpuartdiv;
	uint32_t brrresult;
	...
	{
		brrresult = (uint32_t) (((uint64_t) (periphclkpresc)
				* LPUART_LPUARTDIV_FREQ_MUL) / lpuartdiv);
	}
	else
	{
		brrresult = 0x0UL;
 ...
 */
__STATIC_INLINE uint32_t LL_LPUART_GetDEDeassertionTime(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_RXNE_RXFNE(
		const USART_TypeDef *LPUARTx)
{
	return ((READ_BIT(LPUARTx->ISR, USART_ISR_RXNE_RXFNE)
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_TXE_TXFNF(
		const USART_TypeDef *LPUARTx)
{
	return ((READ_BIT(LPUARTx->ISR, USART_ISR_TXE_TXFNF)
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_TXFE(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_RXFF(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_TXFT(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsActiveFlag_RXFT(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_RXNE_RXFNE(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_TXE_TXFNF(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_TXFE(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_RXFF(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_TXFT(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledIT_RXFT(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledDMAReq_RX(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledDMAReq_TX(
		const USART_TypeDef *LPUARTx)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPUART_IsEnabledDMADeactOnRxErr(
		const USART_TypeDef *LPUARTx)
{
