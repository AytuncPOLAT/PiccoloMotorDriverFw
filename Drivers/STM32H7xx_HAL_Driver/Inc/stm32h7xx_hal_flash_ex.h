...
HAL_StatusTypeDef
HAL_FLASHEx_Unlock_Bank1(void);
HAL_StatusTypeDef
HAL_FLASHEx_Lock_Bank1(void);
#if defined (DUAL_BANK)
...
HAL_StatusTypeDef
HAL_FLASHEx_ComputeCRC(FLASH_CRCInitTypeDef *pCRCInit, uint32_t *CRC_Result);
 ...
 */
void
FLASH_Erase_Sector(uint32_t Sector, uint32_t Banks, uint32_t VoltageRange);
/**
 * @}
 */
