...
__STATIC_INLINE void LL_SYSCFG_SetTIMBreakInputs(uint32_t Break)
{
  ...
  MODIFY_REG(SYSCFG->CFGR, SYSCFG_CFGR_AXISRAML | SYSCFG_CFGR_ITCML  | SYSCFG_CFGR_DTCML  | SYSCFG_CFGR_SRAM1L | SYSCFG_CFGR_SRAM2L | \
	...
	MODIFY_REG(SYSCFG->CFGR,
			SYSCFG_CFGR_AXISRAML | SYSCFG_CFGR_ITCML | SYSCFG_CFGR_DTCML | SYSCFG_CFGR_SRAM1L | SYSCFG_CFGR_SRAM2L | SYSCFG_CFGR_SRAM4L | SYSCFG_CFGR_BKRAML | SYSCFG_CFGR_CM7L | SYSCFG_CFGR_FLASHL | SYSCFG_CFGR_PVDL,
			Break);
#else
...
{
	return ((READ_BIT(SYSCFG->CCCSR, SYSCFG_CCCSR_READY) == (SYSCFG_CCCSR_READY)) ?
			1UL : 0UL);
}
...
#else
	return (uint16_t) ((uint32_t) READ_BIT(SYSCFG->UR2, SYSCFG_UR2_BOOT_ADD0)
...
__STATIC_INLINE uint32_t LL_SYSCFG_IsFlashB1Sector0WriteProtected(void)
{
	return ((READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1)
			== (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR0_STATUS_BIT)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1)
			== (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR1_STATUS_BIT)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1)
			== (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR2_STATUS_BIT)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1)
			== (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR4_STATUS_BIT)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1)
			== (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR5_STATUS_BIT)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1)
			== (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR6_STATUS_BIT)) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SYSCFG->UR12, SYSCFG_UR12_SECURE) == SYSCFG_UR12_SECURE) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SYSCFG->UR17, SYSCFG_UR17_IOHSLV) == SYSCFG_UR17_IOHSLV) ?
			1UL : 0UL);
}
...
{
	return ((READ_BIT(SYSCFG->UR18, SYSCFG_UR18_CPU_FREQ_BOOST)
			== SYSCFG_UR18_CPU_FREQ_BOOST) ? 1UL : 0UL);
}
