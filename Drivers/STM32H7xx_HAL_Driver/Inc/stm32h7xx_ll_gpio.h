 ...
 *         @arg @ref LL_GPIO_MODE_ANALOG
 */
__STATIC_INLINE uint32_t LL_GPIO_GetPinMode(const GPIO_TypeDef *GPIOx,
		uint32_t Pin)
{
 ...
 *         @arg @ref LL_GPIO_OUTPUT_OPENDRAIN
 */
__STATIC_INLINE uint32_t LL_GPIO_GetPinOutputType(const GPIO_TypeDef *GPIOx,
		uint32_t Pin)
{
 ...
 *         @arg @ref LL_GPIO_SPEED_FREQ_VERY_HIGH
 */
__STATIC_INLINE uint32_t LL_GPIO_GetPinSpeed(const GPIO_TypeDef *GPIOx,
		uint32_t Pin)
{
	return (uint32_t) (READ_BIT(GPIOx->OSPEEDR,
			((Pin * Pin) * GPIO_OSPEEDR_OSPEED0)) / (Pin * Pin));
}
 ...
 *         @arg @ref LL_GPIO_PULL_DOWN
 */
__STATIC_INLINE uint32_t LL_GPIO_GetPinPull(const GPIO_TypeDef *GPIOx,
		uint32_t Pin)
{
 ...
 *         @arg @ref LL_GPIO_AF_15
 */
__STATIC_INLINE uint32_t LL_GPIO_GetAFPin_0_7(const GPIO_TypeDef *GPIOx,
		uint32_t Pin)
{
 ...
 *         @arg @ref LL_GPIO_AF_15
 */
__STATIC_INLINE uint32_t LL_GPIO_GetAFPin_8_15(const GPIO_TypeDef *GPIOx,
		uint32_t Pin)
{
 ...
 */
__STATIC_INLINE uint32_t LL_GPIO_IsPinLocked(const GPIO_TypeDef *GPIOx,
		uint32_t PinMask)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_GPIO_IsInputPinSet(const GPIO_TypeDef *GPIOx,
		uint32_t PinMask)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_GPIO_IsOutputPinSet(const GPIO_TypeDef *GPIOx,
		uint32_t PinMask)
{
