 ...
 */
__STATIC_INLINE uint32_t LL_HSEM_IsSemaphoreLocked(const HSEM_TypeDef *HSEMx,
		uint32_t Semaphore)
{
 ...
 */
__STATIC_INLINE uint32_t LL_HSEM_GetCoreId(const HSEM_TypeDef *HSEMx,
		uint32_t Semaphore)
{
 ...
 */
__STATIC_INLINE uint32_t LL_HSEM_GetProcessId(const HSEM_TypeDef *HSEMx,
		uint32_t Semaphore)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_HSEM_SetLock(HSEM_TypeDef *HSEMx, uint32_t Semaphore,
		uint32_t process)
{
 ...
 */
__STATIC_INLINE uint32_t LL_HSEM_1StepLock(const HSEM_TypeDef *HSEMx,
		uint32_t Semaphore)
{
...
__STATIC_INLINE uint32_t LL_HSEM_GetStatus(const HSEM_TypeDef *HSEMx,
		uint32_t Semaphore)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_HSEM_IsEnabledIT_C1IER(const HSEM_TypeDef *HSEMx,
		uint32_t SemaphoreMask)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_HSEM_IsActiveFlag_C1ISR(const HSEM_TypeDef *HSEMx,
		uint32_t SemaphoreMask)
{
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_HSEM_IsActiveFlag_C1MISR(const HSEM_TypeDef *HSEMx,
		uint32_t SemaphoreMask)
{
